...
def parse_args():
    ...
    parser.add_argument('--data-dir', default='dataset/part_A_final', help='data path')
    parser.add_argument('--dataset', default='sha', help='dataset name: qnrf, nwpu, sha, shb, custom')
    parser.add_argument('--lr', type=float, default=1e-5,
                        help='the initial learning rate')
    parser.add_argument('--weight-decay', type=float, default=1e-4,
                        help='the weight decay')
    parser.add_argument('--resume', default=r"D:\soapberry\mengqw\CCTrans-main2\CCTrans-main\ckpts\ALTGVT\CCTrans_12-1-input-256_wot-0.1_wtv-0.01_reg-10.0_nIter-100_normCood-0\1817_ckpt.tar", type=str,
