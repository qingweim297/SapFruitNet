...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_path", type=str, default='dataset/part_A_final/test_data/images/1014'
                                                          '.jpg',
                        help="the image path to be detected.")
    parser.add_argument("--weight_path", type=str, default='best_model_mae-7.50_epoch-1776.pth',
